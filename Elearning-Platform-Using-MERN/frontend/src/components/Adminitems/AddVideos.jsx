        ...
        <Box pt="100px" px={8} pb={10} maxW="container.md" mx="auto">
          ...
          <Box mt={12}>
            <VStack align="start" spacing={1} mb={10}>
              <Heading size="xl" fontWeight="900" letterSpacing="-1.5px">Add Lesson Video</Heading>
              <Text color="whiteAlpha.500" fontWeight="600">Upload a new video lesson to "{title || 'the course'}"</Text>
            </VStack>
            ...
            <Box className="rc-glass" p={10} borderRadius="32px">
              <VStack spacing={6} align="stretch">
                ...
                <FormControl>
                  ...
                  <Textarea
                    placeholder="Short summary of the lesson content..."
                    name="description"
                ...
                <Grid templateColumns={{ base: "1fr", md: "1fr 1fr" }} gap={6}>
                  ...
                  <FormControl>
                    <FormLabel fontSize="sm" fontWeight="800" color="whiteAlpha.400" mb={3}>INITIAL VIEWS</FormLabel>
                    <Input
                      type="number"
                      placeholder="0"
                      name="views"
                ...
                <FormControl>
                  <FormLabel fontSize="sm" fontWeight="800" color="whiteAlpha.400" mb={3}>POSTER IMAGE URL</FormLabel>
                  <Input
                    placeholder="https://..."
                    name="img"
                    value={detail.img}
